...
if __name__ == '__main__':
    ...
    And the lowest prices for caskets can be found on Amazon AMZN, -0.33%   with options at $791 with free shipping through Amazon Prime.
     The Nikkei NIK, -0.23% rose 0.7% after the Bank of Japan left monetary policy on hold.'''
